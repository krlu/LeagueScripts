...
def main():
    pageid = raw_input("Please enter Esportspedia Page ID: ")
    weekcolumn = raw_input("Please enter the name of week column: ")
    teamname = raw_input("Please enter the name of team: ")
